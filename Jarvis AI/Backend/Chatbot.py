...
# Function to modify AI responses by removing unnecessary new lines.
...
def ChatBot(Query):
    ...
    try:
        ...
        completion = client.chat.completions.create(
            ...
            messages=SystemChatBot + [{"role": "system", "content": RealtimeInformation()}] + messages,  # Include system message.
        ...
        # Save the updated chat log to JSON.
        with open(r"Data\\ChatLog.json", "w") as f:
        ...
        # Handle errors by printing the exception message and resetting the chat log.
        print(f"Error: {e}")
        with open(r"Data\\ChatLog.json", "w") as f:
            dump([], f, indent=4)
...
if __name__ == "__main__":
    while True:
        ...
        print(ChatBot(user_input))  # Get response from chatbot.
