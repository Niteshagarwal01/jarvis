...
from pywhatkit import search as playonyt  # Import functions for Google search and YouTube playback.
...
from groq import Groq  # Import gTTS for AI chat functionality.
...
# Function for automated command execution.
